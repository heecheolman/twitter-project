...
<style scoped>
  ...
  /*.profile-wrap__top-section__profile-card--left {*/
    /*display: flex;*/
    /*align-items: center;*/
    /*flex-direction: column;*/
    /*justify-content: center;*/
    ...
    /*height: 150px;*/
  /*}*/
  /*.profile-wrap__top-section__profile-card--left__img-wrap {*/
    /*display: flex;*/
    /*align-items: center;*/
    /*flex-direction: column;*/
    /*justify-content: center;*/
    ...
    /*border-radius: 100%;*/
  /*}*/
  /*.profile-wrap__top-section__profile-card--left__img-wrap__img {*/
    /*width: 100%;*/
    /*height: 100%;*/
  /*}*/
